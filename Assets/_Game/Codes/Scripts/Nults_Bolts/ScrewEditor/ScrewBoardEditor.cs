...
namespace NultBolts
{
    ...
    public class ScrewBoardEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(30);
            if (GUILayout.Button("Fix GreyOwl"))
            {
                Finish(screwBoard,true);
            }
        ...
        public void Finish(ScrewBoard screwBoard,bool GOs=false)
        {
            ...
            foreach (var item in boardScrewHoles)
            {
               ...
               if(GOs)
                    item.transform.SetParent(screwBoard.ScrewHoleHolder, true);
            }
            ...
            foreach (var screw in screws)
            {
                ...
                if(GOs)
                    screw.transform.SetParent(screwBoard.ScrewHolder, true);
            }
